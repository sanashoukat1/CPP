...
cout << "static cast<double>(25) = "<< static_cast<double> (25)<< endl;
cout << "static_cast<double> (5 + 3) ="<< static_cast<double>(5 + 3)<< endl;
cout << "static_cast<double> (15) / 2 ="<< static_cast<double> (15)/2<< endl;
cout << "static_cast<double> (15 / 2) = "<< static_cast<double> (15/ 2)<< endl;
cout << "static cast<int>(7.8 + static cast<double>(15) / 2)="  << static_cast<int>(7.8 + static_cast<double>(15) / 2) << endl;
cout << "static cast<int>(7.8 + static cast<double>(15 / 2)) ="<< static_cast<int>(7.8 + static_cast<double> (15 / 2))<< endl;
return 0;
}